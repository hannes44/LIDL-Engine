...
namespace NetCoreServer
{
    ...
    public class TcpSession : IDisposable
    {
        ...
        /// <returns>Size of sent data</returns>
        public virtual long Send(string text) => Send(Encoding.ASCII.GetBytes(text));
        ...
        /// <returns>Size of sent data</returns>
        public virtual long Send(ReadOnlySpan<char> text) => Send(Encoding.ASCII.GetBytes(text.ToArray()));
        ...
        public virtual bool SendAsync(string text) => SendAsync(Encoding.ASCII.GetBytes(text));
        ...
        /// <param name="text">Text to send as a span of characters</param>
        /// <returns>'true' if the text was successfully sent, 'false' if the session is not connected</returns>
        public virtual bool SendAsync(ReadOnlySpan<char> text) => SendAsync(Encoding.ASCII.GetBytes(text.ToArray()));
        ...
        public virtual string Receive(long size)
        {
            ...
            return Encoding.ASCII.GetString(buffer, 0, (int)length);
        }
