...
namespace NetCoreServer
{
    ...
    public class TcpServer : IDisposable
    {
        ...
        /// <param name="excludeSession">Optional ID of session to exclude from multicast</param>
        /// <returns>'true' if the data was successfully multicasted, 'false' if the data was not multicasted</returns>
        public virtual bool Multicast(byte[] buffer, Guid? excludeSession = null) => Multicast(buffer.AsSpan(), excludeSession);
        ...
        /// <param name="excludeSession">Optional ID of session to exclude from multicast</param>
        /// <returns>'true' if the data was successfully multicasted, 'false' if the data was not multicasted</returns>
        public virtual bool Multicast(byte[] buffer, long offset, long size, Guid? excludeSession = null) => Multicast(buffer.AsSpan((int)offset, (int)size), excludeSession);
        ...
        /// <param name="excludeSession">Optional ID of session to exclude from multicast</param>
        /// <returns>'true' if the data was successfully multicasted, 'false' if the data was not multicasted</returns>
        public virtual bool Multicast(ReadOnlySpan<byte> buffer, Guid? excludeSession = null)
        {
            if (!IsStarted)
                return false;
            ...
            foreach (var session in Sessions.Values.Where(s => s.Id != excludeSession))
        ...
        public virtual bool Multicast(string text, Guid? excludeSession = null) => Multicast(Encoding.ASCII.GetBytes(text), excludeSession);
        ...
        /// <param name="excludeSession">Optional ID of session to exclude from multicast</param>
        /// <returns>'true' if the text was successfully multicasted, 'false' if the text was not multicasted</returns>
        public virtual bool Multicast(ReadOnlySpan<char> text, Guid? excludeSession = null) => Multicast(Encoding.ASCII.GetBytes(text.ToArray()), excludeSession);
